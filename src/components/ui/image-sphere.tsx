...
export interface ImageData {
    ...
    title?: string;
    description?: string;
    glowColor?: string; // Hex color code for the glow effect
}
...
const SphereImageGrid: React.FC<SphereImageGridProps> = ({
    ...
    const handleImageClick = useCallback((index: number, e: React.MouseEvent) => {
        ...
        const tl = gsap.timeline({
            onComplete: () => setClickedIndex(null)
        });
                ...
                <div
                    ...
                    style={{
                        background: image.glowColor
                            ? `radial-gradient(circle, ${image.glowColor}CC, ${image.glowColor}99, ${image.glowColor}66, transparent)`
                            : `radial-gradient(circle, rgba(99, 102, 241, 0.8), rgba(168, 85, 247, 0.6), transparent)`,
                        transform: 'scale(0)',
                        opacity: 0,
                        zIndex: -1
                    }}
