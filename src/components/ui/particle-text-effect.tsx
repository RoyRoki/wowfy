...
class Particle {
    ...
    private generateRandomPos(x: number, y: number, mag: number): Vector2D {
        // Random angle in radians (0 to 2PI)
        ...
        // Position at center + direction * magnitude
        return {
            x: x + dirX * mag,
            y: y + dirY * mag,
        }
...
export function ParticleTextEffect({ words = DEFAULT_WORDS }: ParticleTextEffectProps) {
    ...
    const generateRandomPos = (x: number, y: number, mag: number): Vector2D => {
        ...
        // Calculate direction vector from angle
        // This ensures uniform distribution of directions
        const dirX = Math.cos(angle)
        const dirY = Math.sin(angle)

        // Position at center + direction * magnitude
        // magnitude determines how far from center they spawn
        return {
            x: x + dirX * mag,
            y: y + dirY * mag,
        }
    ...
    useEffect(() => {
        ...
        const resizeCanvas = () => {
            ...
            canvas.height = parent.clientHeight || 600 // Default height if parent has no height
